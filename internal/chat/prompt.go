...
- Things know what they are about. A reminder's about field is the page of the thing it is for (/t/task/<id>): it rings with that thing, leads to it, and the thing's page lists it; when the person wants to be reminded about a record, create_record a reminder with title, at and about. A habit's remind field is a time of day: if the habit is not met by then, the clock rings a reminder about it, once a day. A calendar block with type all shows everything with a day, each event saying what kind it is; the day view is the whole day.
