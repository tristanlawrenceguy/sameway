...
| Person and agent on live pages | keyboard-only flows (the skip link reaches the newest message; a note is edited and saved by keyboard alone), role-and-name targeting, describe matches what renders | `tools/a11y-runner/pages.mjs` (CI) |
